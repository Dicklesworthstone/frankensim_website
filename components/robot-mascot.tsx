 ...
 * A little lab robot mascot with cursor-tracking eyes, echoing the FrankenSim illustration.
 */
  ...
  return (
    ...
    >
      <svg
        ...
        aria-label="FrankenSim lab robot mascot"
      >
        {/* Glow behind robot */}
        <defs>
        ...
        <g transform="translate(52, 108)">
          <rect width="16" height="10" rx="2" fill="#08131a" stroke="#F97316" strokeWidth="0.5" />
        ...
        >
          <rect x="5" y="35" width="14" height="10" rx="2" fill="#08131a" stroke="#22d3ee" strokeWidth="0.5" opacity="0.6" />
          <text x="12" y="42.5" textAnchor="middle" fill="#22d3ee" fontSize="5" fontWeight="bold" fontFamily="monospace" opacity="0.6">Cx</text>
        </motion.g>
        ...
        >
          <rect x="101" y="35" width="14" height="10" rx="2" fill="#08131a" stroke="#22d3ee" strokeWidth="0.5" opacity="0.6" />
          <text x="108" y="42.5" textAnchor="middle" fill="#22d3ee" fontSize="5" fontWeight="bold" fontFamily="monospace" opacity="0.6">Cx</text>
        </motion.g>
      </svg>
    </motion.div>
  );
