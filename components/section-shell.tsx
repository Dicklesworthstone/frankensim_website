...
export default function SectionShell({
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div
                  data-magnetic="true"
                  className="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-500/5 border border-cyan-500/20 text-cyan-400"
                >
      ...
      <div className="absolute bottom-0 left-6 right-6 h-px bg-gradient-to-r from-transparent via-cyan-500/10 to-transparent" />
    </section>
  );
}
