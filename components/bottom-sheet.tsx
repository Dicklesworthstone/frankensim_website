        ...
        <Portal>
          <div className="fixed inset-0 z-[999] flex flex-col justify-end">
            ...
            <motion.div
              ...
              className="relative z-10 w-full max-h-[92vh] overflow-hidden rounded-t-[2.5rem] border-t border-cyan-500/20 bg-[#04090d] shadow-[0_-20px_80px_rgba(0,0,0,0.8)] flex flex-col"
            >
              {/* Header */}
              <div className="sticky top-0 z-20 flex items-center justify-between border-b border-white/5 bg-[#04090d]/90 px-8 py-6 backdrop-blur-xl">
