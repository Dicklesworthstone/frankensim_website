    ...
    <main id="main-content">
      ...
      >
        ...
        <div className="mt-10 flex justify-center">
          <Link
            href="/roadmap"
            className="btn-secondary group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm font-bold text-slate-300 transition-all hover:border-cyan-500/30 hover:bg-white/10 hover:text-white"
          >
