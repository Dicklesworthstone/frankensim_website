...
export default function GlowOrbits() {
  ...
  const spectrum = ["#06b6d4", "#22d3ee", "#a855f7", "#67e8f9", "#0891b2", "#c084fc", "#0e7490", "#38bdf8"];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-1/4 h-64 w-64 rounded-full bg-cyan-500/20 blur-[100px]"
      />
      <motion.div
        animate={{
          scale: [1.2, 1, 1.2],
        ...
        className="absolute bottom-1/4 left-1/3 h-80 w-80 rounded-full bg-violet-500/15 blur-[110px]"
      />
    </motion.div>
  );
}
