...
import {
  Terminal, Cpu, Lock, Shield, Blocks, Sparkles, Activity, Globe,
  Layers, GitCommit, Boxes, Grid3x3, LineChart, Database, Gauge, GitMerge, Zap, Package,
} from "lucide-react";
...
const iconMap: Record<string, React.ElementType> = {
  ...
  layers: Layers, gitCommit: GitCommit, boxes: Boxes, grid: Grid3x3,
  lineChart: LineChart, database: Database, gauge: Gauge, gitMerge: GitMerge,
  zap: Zap, package: Package,
};

const SPECTRUM = ["#06b6d4", "#22d3ee", "#a855f7", "#67e8f9", "#0891b2", "#c084fc", "#38bdf8", "#0e7490"];
