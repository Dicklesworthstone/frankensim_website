    ...
    <>
      <div className="pointer-events-none fixed inset-0 z-[10000] hidden md:block" style={{ willChange: "transform" }}>
        ...
        {isVisible && (
          <>
            <motion.div
              className="absolute left-0 top-0 h-10 w-10 rounded-full border border-cyan-500/40"
              style={{
               ...
               <AnimatePresence>
                 {isClicking && (
                   <motion.div
                     ...
                     exit={{ opacity: 0 }}
                     className="absolute inset-[-10px] border border-violet-500/50 rounded-full"
                   />
                 )}
               </AnimatePresence>
            </motion.div>
            ...
            <motion.div
              className="absolute left-0 top-0 h-1.5 w-1.5 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34, 211, 238,0.8)]"
              style={{
                x: mouseX,
                y: mouseY,
                translateX: "-50%",
              ...
              animate={{
                ...
                backgroundColor: isClicking ? "#ef4444" : "#22d3ee",
              }}
            />
          </>
        )}
        ...
        <AnimatePresence>
          {isVisible && isPointer && !isMagnetic && (
            ...
            >
              <div className="absolute top-[-15px] left-1/2 h-[8px] w-[1px] bg-cyan-500/60 -translate-x-1/2" />
              <div className="absolute bottom-[-15px] left-1/2 h-[8px] w-[1px] bg-cyan-500/60 -translate-x-1/2" />
              <div className="absolute left-[-15px] top-1/2 w-[8px] h-[1px] bg-cyan-500/60 -translate-y-1/2" />
              <div className="absolute right-[-15px] top-1/2 w-[8px] h-[1px] bg-cyan-500/60 -translate-y-1/2" />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
