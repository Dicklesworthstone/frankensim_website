          ...
          {activeDoc ? (
            ...
            >
              <button
                ...
                className="flex items-center gap-2 text-sm font-bold text-cyan-400 mb-6 hover:text-cyan-300 transition-colors"
              >
        ...
        <div className="pl-8 overflow-y-auto max-h-[85vh] custom-scrollbar">
          <AnimatePresence mode="wait">
            {activeDoc ? (
              ...
              >
                <FileText className="h-16 w-16 text-cyan-500/20 mb-6" />
...
function CategoryHeading({ category }: { category: SpecCategory }) {
  ...
  return (
    <div className="flex items-center gap-2 pb-2 pt-4 px-1">
      <CatIcon className="h-3.5 w-3.5 text-cyan-500/60" />
      ...
      <Magnetic strength={0.05}>
        <button
          ...
          className={cn(
            ...
            active
              ? "bg-cyan-500/10 border-cyan-500/30 shadow-[0_0_20px_rgba(59,130,246,0.1)]"
          ...
          <div className="flex items-center justify-between">
            <h4
              className={cn(
                ...
                active ? "text-cyan-400" : "text-white group-hover:text-cyan-400"
              )}
            >
              {doc.title}
            </h4>
            <ChevronRight
              className={cn(
                ...
                active ? "text-cyan-400 translate-x-0.5" : "text-slate-700 group-hover:text-slate-500"
              )}
            />
          </div>
    ...
    <div className="mb-8 pb-8 border-b border-white/5">
      <div className="flex items-center gap-3 mb-4">
        <div className="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
          <CatIcon className="h-3 w-3 text-cyan-400" />
          <span className="text-[9px] font-black uppercase tracking-[0.3em] text-cyan-400">{doc.category}</span>
        </div>
